...
interface DateRangePickerProps {
  label?: string;
  onDateRangeSelect: (dateRange: { start: Date; end: Date }) => void;
  value: { start: Date; end: Date };
}

export const DateRangePicker = ({ label, onDateRangeSelect, value: { start, end } }: DateRangePickerProps) => {
    ...
    <Box>
      ...
      >
        ...
        >
          <Popover.Pane fixed>
            <InlineGrid
              columns={{ xs: '1fr', md: 'max-content max-content' }}
              gap="0"
            >
              <div
                style={{
